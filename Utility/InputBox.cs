...
namespace Scrabble.Utility.MsgBox
{
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            switch (icon)
            {
                ...
                case Icon.Information:
                    stream = assembly.GetManifestResourceStream(@"Scrabble.Utility.MsgBox.Information.png");
                    break;
                case Icon.Question:
            ...
            picture.Image = System.Drawing.Image.FromFile("info.png");
